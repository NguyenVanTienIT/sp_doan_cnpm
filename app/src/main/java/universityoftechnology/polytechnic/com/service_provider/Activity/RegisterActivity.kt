...
class RegisterActivity : AppCompatActivity() {
    ...
    fun initView() {
        ...
        progress = ProgressDialog(this@RegisterActivity)
            ...
            try {
                ...
                if (success.equals("true")) { // username chưa tồn tại
                    ...
                    var user: User = User(
                        ...
                        editNameNhahang!!.text.toString(),
                        editEmail!!.text.toString(),
                        editNumberPhone!!.text.toString(),
                        editAddress!!.text.toString()
                    )
                    Log.d("ket_qua", "dang ki")
                    progress!!.cancel()
                    RegisterUser(user)
                } else {
                    progress!!.cancel()
                    check = true
                    Toast.makeText(applicationContext, "Username đã tồn tại", Toast.LENGTH_SHORT).show()
                    Log.d("ket_qua", "khong dang ki")
                }
            } catch (e: Exception) {
                Log.d("ket_qua", e.toString())
                progress!!.cancel()
            }
